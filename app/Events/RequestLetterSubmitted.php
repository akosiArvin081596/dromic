...
class RequestLetterSubmitted implements ShouldBroadcast
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    /**
     * @param  array{id: int, incident_id: int, incident_name: string, city_municipality_name: string, user_name: string, item_count: int, message: string}  $requestLetterData
    ...
    /**
     * Serialize a RequestLetter model to a plain array for broadcasting.
     *
     * @return array{id: int, incident_id: int, incident_name: string, city_municipality_name: string, user_name: string, item_count: int, message: string}
     */
