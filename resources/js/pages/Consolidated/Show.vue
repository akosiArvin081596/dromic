                ...
                <template v-if="selectedCutoff">
                    ...
                    <div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="border border-l-4 border-slate-200 border-l-purple-500 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
                            <div class="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Total Displaced (Inside + Outside EC)</div>
                            <div class="mt-3 grid grid-cols-2 gap-4">
                                <div>
                                    <div class="text-xs font-semibold text-purple-600 dark:text-purple-400">Families</div>
                                    <div class="mt-1 grid grid-cols-2 gap-2 text-center">
                                        <div>
                                            ...
                                            <div class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ (selectedCutoff.totals.inside_ec_families_cum + selectedCutoff.totals.outside_ec_families_cum).toLocaleString() }}</div>
                                        </div>
                                        <div>
                                            <div class="text-[10px] uppercase text-slate-400 dark:text-slate-500">Now</div>
                                            <div class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ (selectedCutoff.totals.inside_ec_families_now + selectedCutoff.totals.outside_ec_families_now).toLocaleString() }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-1 grid grid-cols-2 gap-2 text-center">
                                        <div>
                                            <div class="text-[10px] uppercase text-slate-400 dark:text-slate-500">Cum</div>
                                            <div class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ (selectedCutoff.totals.inside_ec_persons_cum + selectedCutoff.totals.outside_ec_persons_cum).toLocaleString() }}</div>
                                        </div>
                                        <div>
                                            <div class="text-[10px] uppercase text-slate-400 dark:text-slate-500">Now</div>
                                            <div class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ (selectedCutoff.totals.inside_ec_persons_now + selectedCutoff.totals.outside_ec_persons_now).toLocaleString() }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
