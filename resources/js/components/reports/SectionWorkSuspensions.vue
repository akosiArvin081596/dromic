...
import { emptyWorkSuspension } from '@/composables/useReportCalculations';
import type { WorkSuspension } from '@/types';

const rows = defineModel<WorkSuspension[]>('rows', { required: true });

function addRow() {
    rows.value.push(emptyWorkSuspension());
}
...
<template>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-slate-900">XI. Work Suspension</h3>
            ...
            <table class="min-w-full divide-y divide-slate-200 border">
                <thead class="bg-indigo-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium tracking-wider text-slate-500">Office/Agency</th>
                    ...
                    <tr v-for="(row, index) in rows" :key="index">
                        ...
                        <td class="px-4 py-2">
                            <input
                                ...
                                placeholder="e.g. City Hall, DPWH"
                            />
                        </td>
                        <td class="px-4 py-2">
                            <input
