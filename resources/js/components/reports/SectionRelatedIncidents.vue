...
import { emptyRelatedIncident } from '@/composables/useReportCalculations';
import type { Barangay, RelatedIncident } from '@/types';
...
const rows = defineModel<RelatedIncident[]>('rows', { required: true });

function addRow() {
    rows.value.push(emptyRelatedIncident());
}
...
<template>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-slate-900">V. Related Incidents</h3>
            ...
            <table class="min-w-full divide-y divide-slate-200 border">
                <thead class="bg-indigo-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium tracking-wider text-slate-500">Incident Type</th>
